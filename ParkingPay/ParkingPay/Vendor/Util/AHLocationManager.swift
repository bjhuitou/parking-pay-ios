...
fileprivate let locRequestTitle = R.string.parkingLocalizable.locationRequestTitle()
fileprivate let locHelpMessage = R.string.parkingLocalizable.locationHelpMessage()
/*
   坐标系：
     WGS-84：是国际标准，GPS坐标（Google Earth使用、或者GPS模块）
     GCJ-02：中国坐标偏移标准，Google Map、高德、腾讯使用
