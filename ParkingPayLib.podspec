...
Pod::Spec.new do |s|
  ...
  s.name         = "ParkingPayLib"
  s.version      = "0.0.1"
  s.summary      = "ParkingPayLib."
  ...
  s.description  = <<-DESC
                    this is ParkingPayLib
                   DESC

  s.homepage     = "https://github.com/bjhuitou/parking-pay-ios.git"
  ...
  s.source_files  = "ParkingPay/ParkingPay/**/*.{h,m,swift}"
  ...
  # s.resource  = "icon.png"
  s.resource = "ParkingPay/ParkingPay/Resource/**/*.{storyboard,png,xcassets,strings,xib}"
  ...
  s.dependency "TBEmptyDataSet", "2.7"
